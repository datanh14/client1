    ...
    >
      ...
      <Form.Item label="Quận">
        <Select
          ...
          allowClear
        >
          <Select.Option value="0a16de60-299e-4a79-9180-3d253dc9bbb0">Huyện Ba Vì</Select.Option>
          <Select.Option value="15abf600-731e-4ae6-99ea-1478d0b8ce95">Huyện Phú Xuyên</Select.Option>
          ...
          <Select.Option value="78dfb396-313f-4068-a5e1-faaa5aa4be65">Huyện Mỹ Đức</Select.Option>
          ...
          <Select.Option value="8d74a79b-9a47-4dfd-b374-412063becdce">Quận Nam Từ Liêm</Select.Option>
          <Select.Option value="aa82fde1-9ee7-4e04-8b7f-2384e5310a86">Huyện Thanh Trì</Select.Option>
          <Select.Option value="ab244c62-d87f-423b-b1e6-b1983026ece5">Huyện Thanh Oai</Select.Option>
          <Select.Option value="ad7438b7-7593-46d4-9c7b-99f32734fba2">Huyện Đan Phượng</Select.Option>
          <Select.Option value="b14ccd35-5d7c-436b-ad59-b1f847c7c485">Quận Thanh Xuân</Select.Option>
        </Select>
      </Form.Item>
