...
const dataItems = [
  {
    sale: true,
    id: 1,
    img: "https://salt.tikicdn.com/ts/banner/06/af/22/c5783f6d2c935633f21659b64e6af628.jpg",
    title: "ok",
    gia: "100d",
  ...
  },
  {
    sale: true,
    id: 2,
    img: "https://salt.tikicdn.com/ts/banner/06/af/22/c1aec3dd9d1a316783a4c5d1bbffdf58.jpg",
    title: "ok",
    gia: "100d",
    dir: "Gối Tựa Lưng Sofa Hình Học Thổ Cẩm PA9251",
    sao: 2,
  },
  {
    sale: true,
    id: 3,
    img: "https://salt.tikicdn.com/ts/banner/94/24/36/805d8a739056734bb60e82bdfd9a76ff.jpg",
    title: "ok",
    gia: "100d",
    dir: "Gối Tựa Lưng Sofa Hình Học Thổ Cẩm PA9251",
    sao: 2,
  },
  {
    sale: false,
    id: 4,
    img: "https://salt.tikicdn.com/ts/banner/c7/1e/29/cad2cd9b123bf09897e902400910d4cb.jpg",
    title: "ok",
    gia: "100d",
    dir: "Gối Tựa Lưng Sofa Hình Học Thổ Cẩm PA9251",
    sao: 2,
    ...
    <div className={classes.root}>
      ...
      <div className={classes.slider} ref={sliderRef}>
        {dataItems.map((item: some, index: number) => {
          return (
            <Box className={classes.boxImg} key={index}>
